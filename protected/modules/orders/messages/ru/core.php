<?php
     return array(
        ...
        'Photo'=>'Фотография',
        'Sum'=>'Сумма',
		'Your discount is'=>'Ваша накопительная скидка',
		'Your promo discount is'=>'Ваша скидка по промо коду',
		'Enter Coupon or Promo code'=>'Купон на скидку',
		'Enter your voucher code below'=>'Введите ваш купон на скидку',
		'Please register, to use gift coupon'=>'Пожалуйста зарегистрируйтесь, чтобы использовать скидочный купон',
		'Proceed to Checkout'=>'Перейти к Оплате',
		'Apply'=>'Применить',
		'Update Cart'=>'Пересчитать',
