...
class UserProfile extends BaseModel
{
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'user_id'          => Yii::t('UsersModule.core', 'User id'),
			'full_name'        => Yii::t('UsersModule.core', 'Full name'),
			'phone'            => Yii::t('UsersModule.core', 'Phone'),
			'delivery_address' => Yii::t('UsersModule.core', 'Delivery address'),
		);
	}
